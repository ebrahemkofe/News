 ...
 */
public class CustomPagerAdaptersixith extends PagerAdapter {
    ...
    public CustomPagerAdaptersixith(Context context, List listDate) {
        mContext = context;
        list = listDate;
        list2 = list.get(5).getCategory_posts();
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        name.setText(list.get(5).getCategory_title());
