 ...
 */
public class CustomPagerAdapterfourth extends PagerAdapter {
    ...
    public CustomPagerAdapterfourth(Context context, List listDate) {
        mContext = context;
        list = listDate;
        list2 = list.get(3).getCategory_posts();
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        name.setText(list.get(3).getCategory_title());
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MyUtils.CategoryTittle = list.get(3).getCategory_title();
                MyUtils.PostID= String.valueOf(list.get(3).getCategory_posts().get(position).getPost_id());
