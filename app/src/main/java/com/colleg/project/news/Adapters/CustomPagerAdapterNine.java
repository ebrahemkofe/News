 ...
 */
public class CustomPagerAdapterNine extends PagerAdapter {
    ...
    public CustomPagerAdapterNine(Context context, List listDate) {
        mContext = context;
        list = listDate;
        list2 = list.get(8).getCategory_posts();
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        name.setText(list.get(8).getCategory_title());
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                MyUtils.CategoryTittle = list.get(8).getCategory_title();
                MyUtils.PostID= String.valueOf(list.get(8).getCategory_posts().get(position).getPost_id());
